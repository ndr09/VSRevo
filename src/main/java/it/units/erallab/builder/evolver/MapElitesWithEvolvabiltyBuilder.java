...
public class MapElitesWithEvolvabiltyBuilder implements EvolverBuilder<List<Double>>  {
    ...
    private final MapElitesWithEvolvabilityEvolver.SelectionStrategies sf;


    public MapElitesWithEvolvabiltyBuilder(MapElitesBuilder.SpeciationCriterion criterion, Mutation<List<Double>> mutation, int map_size, int population_size, int batch_size, MapElitesWithEvolvabilityEvolver.SelectionStrategies sf) {
